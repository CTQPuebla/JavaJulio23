...
* The original package name 'com.ms-productos' is invalid and this project uses 'com.msproductos' instead.
...
* [Jersey](https://docs.spring.io/spring-boot/docs/2.7.14/reference/htmlsinge/index.html#web.servlet.jersey)
